...
import { ArrowLeft, LogOut, Mail, MapPin, Building } from "lucide-react";
...
function BuyerProfile() {
  ...
  return (
    <div className="space-y-6">
      <Button variant="outline" onClick={() => navigate({ to: "/buyer" })}>
        ...
        <div className="surface-panel mt-6 p-6">
          <div className="mb-6 border-b border-border pb-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-muted-foreground">Buyer</p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-6 rounded-lg border border-info/50 bg-info/15 p-4">
            <p className="text-sm text-info-foreground">
              ...
              not yet implemented. Production systems would include fields for phone number, address,
